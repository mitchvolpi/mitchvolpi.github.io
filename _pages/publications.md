...
, T. Olevski, F. P�rez-Cruz, G. Obozinski, and J.
    ...
    <dd id="bib-29" class="thebibliography">
      ...
      <p class="noindent">S. Landwehr, M.Volpi, F. Perez-Cruz, and J. Schmale.
        ...
        In: <span class="cmti-10">Data Science in Climate and Climate Impact Research</span>. 2020.
    </dd>
    ...
    <dd id="bib-30" class="thebibliography">
      ...
      <p class="noindent">S. Landwehr, R. Modini, J. Schmale, M.Volpi, A. Toffoli, I.
        ...
        In: <span class="cmti-10">SOLAS open science conference</span>. 2019.
    </dd>
    ...
    <dd id="bib-36" class="thebibliography">
      ...
      <p class="noindent">D. Marcos, M.Volpi, and D. Tuia. &#8220;Learning rotation
        ...
        <span class="cmti-10">Cancun (MEX)</span>. 2016.
    </dd>
    ...
    <dd id="bib-39" class="thebibliography">
      ...
      <p class="noindent"><span class="cmbx-10">M. Volpi </span>and D. Tuia. &#8220;Semantic labeling of aerial images
        by
        learning class-specific object proposals&#8221;. In: <span class="cmti-10">IEEE International</span>
        <span class="cmti-10">Geosciences and Remote Sensing Symposium IGARSS 2016,</span>
        <span class="cmti-10">Beijing (CHN)</span>. 2016.
    </dd>
    ...
    <dd id="bib-40" class="thebibliography">
      ...
      <p class="noindent"><span class="cmbx-10">M. Volpi </span>and V. Ferrari. &#8220;Semantic segmentation of urban
        scenes
        by learning local class interactions&#8221;. In: <span class="cmti-10">IEEE/CVF CVPRW 2015</span>
        <span class="cmti-10">Earthvision (2015), Boston (USA)</span>. <span class="cmbx-10">Best Paper Award</span>.
        2015.
    </dd>
    ...
    <dd id="bib-41" class="thebibliography">
      ...
      <p class="noindent"><span class="cmbx-10">M. Volpi </span>and V. Ferrari. &#8220;Structured Prediction for urban
        scene
        semantic segmentation with geographic context&#8221;. In: <span class="cmti-10">Joint Urban</span>
        <span class="cmti-10">Remote Sensing Event JURSE 2015, Lausanne (CH)</span>. 2015.
    </dd>
    ...
    <dd id="bib-43" class="thebibliography">
      <!--l. 43-->
      <p class="noindent"><span class="cmbx-10">M. Volpi </span>and D. Tuia. &#8220;Spatially aware supervised nonlinear
        dimensionality reduction for hyperspectral data&#8221;. In: <span class="cmti-10">In 6th</span>
        <span class="cmti-10">Workshop in Hyperspectral Image and Signal Processing: Evolution</span>
    ...
    <dd id="bib-44" class="thebibliography">
      ...
      <p class="noindent">G. Matasci, L. Bruzzone, M.Volpi, D. Tuia, and M. Kanevski.
        ...
        <span class="cmti-10">Barcelona (SP)</span>. 2013.
    </dd>
    ...
    <dd id="bib-45" class="thebibliography">
      ...
      <p class="noindent">M. Trolliet, D. Tuia, and M.Volpi. &#8220;Classification of
        ...
        <span class="cmti-10">(BRA)</span>. 2013.
    </dd>
    ...
    <dd id="bib-48" class="thebibliography">
      <!--l. 43-->
      <p class="noindent"><span class="cmbx-10">M. Volpi</span>, F. de&#x00A0;Morsier, G. Camps-Valls, M. Kanevski, and
        D.
        Tuia. &#8220;Multi-sensor change detection based on nonlinear canonical
        correlations&#8221;. In: <span class="cmti-10">IEEE International Geosciences and Remote</span>
        <span class="cmti-10">Sensing Symposium IGARSS 2013, Melbourne (AUS)</span>. 2013.
    </dd>
    ...
    <dd id="bib-49" class="thebibliography">
      ...
      <p class="noindent"><span class="cmbx-10">M. Volpi</span>, G. Matasci, M. Kanevski, and D. Tuia. &#8220;Multi-view
        feature extraction
        for hyperspectral image classification&#8221;. In: <span class="cmti-10">European Symposium</span>
        <span class="cmti-10">on Artificial Neural Networks, Computational Intelligence and</span>
        <span class="cmti-10">Machine Learning ESANN 2013, Bruges (B)</span>. 2013.
    </dd>
    ...
    <dd id="bib-51" class="thebibliography">
      ...
      <p class="noindent"><span class="cmbx-10">M. Volpi</span>, G. Matasci, D. Tuia, and M. Kanevski. &#8220;Enahnced
        change detection using nonlinear feature extraction&#8221;. In: <span class="cmti-10">IEEE</span>
        <span class="cmti-10">International Geosciences and Remote Sensing Symposium</span>
        <span class="cmti-10">IGARSS 2012, Munich (D)</span>. 2012, pp. 6757&#8211;6760.
    </dd>
    ...
    <dd id="bib-53" class="thebibliography">
      <!--l. 43-->
      <p class="noindent"><span class="cmbx-10">M. Volpi</span>, D. Tuia, G. Camps-Valls, and M. Kanevski.
        &#8220;Unsupervised change detection in the feature space using
        kernels&#8221;. In: <span class="cmti-10">IEEE International Geosciences and Remote Sensing</span>
        <span class="cmti-10">Symposium IGARSS 2011, Vancouver (CAN)</span>. 2011, pp. 106&#8211;109.
    </dd>
    ...
    <dd id="bib-55" class="thebibliography">
      <!--l. 43-->
      <p class="noindent"><span class="cmbx-10">M. Volpi</span>, D. Tuia, G. Camps-Valls, and M. Kanevski.
        &#8220;Unsupervised change detection by kernel clustering&#8221;. In: <span class="cmti-10">SPIE</span>
        <span class="cmti-10">Image and Signal Processing for Remote Sensing XVI, Toulouse</span>
    ...
    <dd id="bib-56" class="thebibliography">
      ...
      <p class="noindent"><span class="cmbx-10">M. Volpi</span>, D. Tuia, and M. Kanevski. &#8220;Advanced active
        sampling
        for remote sensing image classification&#8221;. In: <span class="cmti-10">IEEE International</span>
        <span class="cmti-10">Geosciences and Remote Sensing Symposium IGARSS 2010,</span>
    ...
    <dd id="bib-57" class="thebibliography">
      ...
      <p class="noindent"><span class="cmbx-10">M. Volpi</span>, D. Tuia, M. Kanevski, F. Bovolo, and L. Bruzzone.
        &#8220;Supervised change detection in VHR images: a comparative
        analysis&#8221;. In: <span class="cmti-10">IEEE International Workshop on Machine Learning</span>
        <span class="cmti-10">for Signal Processing MLSP 2009, Grenoble (F)</span>. 2009, pp. 1&#8211;6.
    </dd>
  </dl>
  <!--l. 48-->
  <p class="noindent">
...
. &#8220;Wildland-Urban Interface evolution
    ...
    <dd id="bib-59" class="thebibliography">
      <!--l. 48-->
      <p class="noindent"><span class="cmbx-10">M. Volpi</span>, G. P. Petropoulos, and M. Kanevski. &#8220;Flooded
        area cartography with kernel-based classifiers and Landsat TM
        imagery&#8221;. In: <span class="cmti-10">European Geosciences Union General Assembly EGU</span>
    ...
    <dd id="bib-60" class="thebibliography">
      ...
      <p class="noindent"><span class="cmbx-10">M. Volpi </span>and M. Kanevski. &#8220;Kernel-based methods for change
        detection in remote sensing optical images (sollicited talk)&#8221;.
        In: <span class="cmti-10">European Geosciences Union General Assembly EGU 2011,</span>
        <span class="cmti-10">Vienna (AUT)</span>. 2011.
    </dd>
    ...
    <dd id="bib-62" class="thebibliography">
      ...
      <p class="noindent">F. Humair, M. Charri�re, A. Pedrazzini, M. G�ell Pons, M.Volpi,
        ...
        <span class="cmti-10">Conference of the Canadian Geotechnical Society 2010, Calgary</span>
        <span class="cmti-10">(CAN)</span>. 2010.
    </dd>
    ...
    <dd id="bib-64" class="thebibliography">
      ...
      <p class="noindent"><span class="cmbx-10">M. Volpi</span>, D. Tuia, and M. Kanevski. &#8220;Supervised change
        detection in VHR images using support vector machines and
        contextual information&#8221;. In: <span class="cmti-10">European Geosciences Union General</span>
        <span class="cmti-10">Assembly EGU 2010, Vienna (AUT)</span>. 2010.
    </dd>
    ...
    <dd id="bib-65" class="thebibliography">
      ...
      <p class="noindent"><span class="cmbx-10">M. Volpi</span>, D. Tuia, and M. Kanevski. &#8220;Unsupervised binary
        change detection in VHR images using a kernelized clustering
        algorithm&#8221;. In: <span class="cmti-10">European Geosciences Union General Assembly</span>
  ...
  <dl class="thebibliography">
    ...
    <dd id="bib-66" class="thebibliography">
      ...
      <p class="noindent"><span class="cmbx-10">M. Volpi</span>, S. Landwehr, J. Thomas, and J. Schmale. <span
        ...
        <span class="cmti-10">to the nearest land/coastline (including small subantarctic islands)</span>
        <span class="cmti-10">for the five-minute average cruise track of the Antarctic</span>
        <span class="cmti-10">Circumnavigation Expedition (ACE) during the austral summer of</span>
        <span class="cmti-10">2016/2017</span>. http://dx.doi.org/10.5281/zenodo.3832045. 2020.
    </dd>
    <dt id="X0-volpi2020dataeratrack" class="thebibliography">
      [Vol+20] </dt>
    <dd id="bib-67" class="thebibliography">
      <!--l. 53-->
      <p class="noindent"><span class="cmbx-10">M.</span>
        <span class="cmbx-10">Volpi</span>, S. Landwehr, J. Thomas, and J. Schmale. <span class="cmti-10">ERA-5
          reanalysis</span>
        <span class="cmti-10">results interpolated onto the five-minute average cruise track of the</span>
        <span class="cmti-10">Antarctic Circumnavigation Expedition (ACE) during the austral</span>
        <span class="cmti-10">summer of 2016/2017</span>. http://dx.doi.org/10.5281/zenodo.3831980.
        2020.
    </dd>
    ...
    <dd id="bib-69" class="thebibliography">
      ...
      <p class="noindent"><span class="cmbx-10">M. Volpi</span>. <span class="cmti-10">Semantic interpretation of
          optical remote sensing data</span>
        <span class="cmti-10">by computer vision and machine learning</span>. Keynote talk at Applied
        Machine Learning Days (AMLD), Lausanne (CH). 2019.
    </dd>
    ...
    <dd id="bib-70" class="thebibliography">
      ...
      <p class="noindent"><span class="cmbx-10">M. Volpi </span>and V. Ferrari. <span class="cmti-10">Semantic
          Segmentation of remote</span>
        <span class="cmti-10">sensing urban scene by incorporating the gegeographic context</span>.
        Invited Seminar, University of Zurich (CH). 2014.
    </dd>
    ...
    <dd id="bib-71" class="thebibliography">
      <!--l. 53-->
      <p class="noindent"><span class="cmbx-10">M. Volpi </span>and V. Ferrari. <span class="cmti-10">Semantic
          segmentation of remotely</span>
        <span class="cmti-10">sensed urban scenes</span>. IPAB Workshop @ University of Edinburgh
        (UK). 2014.
    </dd>
    ...
    <dd id="bib-72" class="thebibliography">
      <!--l. 53-->
      <p class="noindent"><span class="cmbx-10">M. Volpi</span>, F. de Morsier, M. Kanevski, G. Matasci, J.
        Stamenkovic, J.-P. Thiran, and D. Tuia. <span class="cmti-10">Kernel-based automatic</span>
        <span class="cmti-10">change detection in remote sensing optical images</span>. Machine
        Learning Workshop @ EPFL, Lausanne (CH). 2012.
    ...
    <dd id="bib-73" class="thebibliography">
      ...
      <p class="noindent"><span class="cmbx-10">M. Volpi </span>and M. Kanevski. <span class="cmti-10">Kernel-based
        ...
        <span class="cmti-10">algorithms for change detection in remote sensing images</span>. Swiss
        French Geomatics Meeting, University of Geneva (CH). 2010.
    </dd>
    ...
    <dd id="bib-74" class="thebibliography">
      <!--l. 53-->
      <p class="noindent"><span class="cmbx-10">M. Volpi</span>, D. Tuia, G. Camps-Valls, and M. Kanevski.
        <span class="cmti-10">Unsupervised change detection by kernel clustering</span>. Invited
        Seminar, National Center for Geocomputation (NCG), Maynooth
        (IRL). 2010.
    </dd>
    ...
    <dd id="bib-75" class="thebibliography">
      ...
      <p class="noindent"><span class="cmbx-10">M. Volpi</span>, D. Tuia, and M. Kanevski. <span class="cmti-10">Active
          learning of remote</span>
        <span class="cmti-10">sensing images</span>. S4 Workshop, Spatio-Temporal Data Analysis,
        Cork (IRL). 2010.
    </dd>
  </dl>
